...
function ReviewItem({
  ...
  return (
    <div className="review">
            ...
            <div className="row mb-6">
              ...
              <div className="col-12">
                ...
                <span className="font-size-xs text-muted">
                  {user.name || ""},{" "}
                  <time dateTime="2019-07-25">{date || ""}</time>
                </span>
              </div>
            </div>
            {/* Title */}
      ...
      {comment &&
        comment?.length > 0 &&
        comment.map((subcmt: ReviewProps) => {
          const { user, date, stars, title, content, like, dislike, comment } =
            subcmt;
          return (
                  ...
                  <div className="col-12 col-md">
                    ...
                    <div className="row mb-6">
                      ...
                      <div className="col-12">
                        ...
                        <span className="font-size-xs text-muted">
                          {user?.name || 0},{" "}
                          <time dateTime="2019-07-14">{date || ""}</time>
                        </span>
                      </div>
                    </div>
                    {/* Title */}
